...
public class KNoVelocity2 extends javax.swing.JFrame {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(58, 58, 58)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(Dis, javax.swing.GroupLayout.PREFERRED_SIZE, 219, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(Dis, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(9, 9, 9)
                .addComponent(jLabel5)
                .addGap(17, 17, 17)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void EnterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EnterActionPerformed
        try{
            if("".equals(Vel1.getText())){
                ...
                Answer.setText("d = "+calculation2(v1,a,t));
            }
                ...
                Answer.setText("a = "+calculation3(d,v1,t));
            }
                ...
                Answer.setText("t = "+calculation4(d,v1,a));
            }
    ...
    private double calculation1(double x, double y, double z){
        double val = (x - (y*0.5 *z*z))/z;
        return val;
    }
    
    private double calculation2(double x, double y, double z){
        double val = (x*z) + (0.5*y*z*z);
        return val;
    }
    
    private double calculation3(double x, double y, double z){
        double val = 2*(x-(y*z))/(z*z);
        return val;
    }
    
    private double calculation4(double x, double y, double z){
        double val;
        double z2 = Math.sqrt(y*y-(2*z*x));
        val = (-y+z2)/z;
        return val;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KNoVelocity2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
