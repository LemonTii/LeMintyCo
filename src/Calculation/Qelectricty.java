...
public class Qelectricty extends javax.swing.JFrame {
    
    double N;
    double Q;
    double e = ((Math.pow(10,-19))*1.6);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Qelectricty.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
